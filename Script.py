...
<b>🤖 ɪ ᴀᴍ <a href=https://t.me/{}>{}</a>, ONLY AVILABLE FOR DOWNTOWN VILLA.</b>
"""
...
├⍟ Lɪʙʀᴀʀʏ : <a href='https://docs.pyrogra.org/'>ᴘʏʀᴏɢʀᴀᴍ</a>
├⍟ Lᴀɴɢᴜᴀɢᴇ : <a href='https://www.python.rg/download/releases/3.0/'>ᴘʏᴛʜᴏɴ 𝟹</a> 
├⍟ Dᴀᴛᴀʙᴀsᴇ : <a href='https://www.mongodb.cm/'>ᴍᴏɴɢᴏ ᴅʙ</a> 
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/D_W_T_1'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @D_W_T_1
