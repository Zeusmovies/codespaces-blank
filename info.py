...
API_ID = int(environ.get('API_ID', '5927744')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', "d8520c2d4515a7718cc41e398ec3ae28")  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "2078178330:AAH3exBiiMxngykHtSjvYlp3iK8BbB8gpJs")    # Bot token from @BotFather
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1325856871').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001705563862').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001497551448'))  # Log channel id (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://zeusmovies:zeus123@cluster0.m7kwkra.mongodb.net/?retryWrites=true&w=majority")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://zeusmovies:zeus123@cluster0.m7kwkra.mongodb.net/?retryWrites=true&w=majority")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/D_W_T_1")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/D_W_T_1")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/D_W_T_1")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/D_W_T_1') # Group link for the bot FOR NOW WE AD THE CAHANNEL
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/D_W_T_1') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/D_W_T_1') # Update channel link for the bot
...
BUTTON_MODE = is_enabled((environ.get('', "True")), False) # pm & Group button or link mode (True) / Off (False)
